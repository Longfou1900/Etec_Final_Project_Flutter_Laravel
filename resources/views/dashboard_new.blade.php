...
<div id="authScreen" class="auth-screen">
    <div class="auth-left">
        <div style="width:100%;max-width:360px">
            ...
            <!-- LOGIN VIEW -->
            <div id="loginView">
                <div class="auth-logo">⌚ Etec Watch Store</div><!--CamboTech-->
                <p class="auth-subtitle">Sign in to your dashboard</p>
                <form onsubmit="doLogin(this.querySelector('.btn-primary'));return false;" autocomplete="on">
                <div class="form-group">
                    <label class="form-label">Email</label>
                    <input class="form-input" id="loginUser" name="email" placeholder="Enter email" type="email" autocomplete="email">
                </div>
                <div class="form-group">
                    <label class="form-label">Password</label>
                    <div class="input-wrap">
                        <input class="form-input" id="loginPass" name="password" type="password" placeholder="Enter password" autocomplete="current-password">
            ...
            <div id="registerView" style="display:none">
                ...
                <form onsubmit="doRegister(this.querySelector('.btn-primary'));return false;" autocomplete="on">
                <div class="form-group">
                    <label class="form-label">Username</label>
                    <input class="form-input" id="regName" name="username" placeholder="Your username" autocomplete="username">
                </div>
                <div class="form-group">
                    <label class="form-label">Email</label>
                    <input class="form-input" id="regEmail" name="email" placeholder="your@email.com" type="email" autocomplete="email">
                </div>
                <div class="form-group" style="margin-bottom:30px">
                    <label class="form-label">Password</label>
                    <div class="input-wrap">
                        <input class="form-input" id="regPass" name="password" type="password" placeholder="Create password" autocomplete="new-password">
                        <i class="ti ti-eye input-icon" id="regEye" onclick="togglePw('regPass','regEye')"></i>
                    </div>
                </div>
                <button type="submit" class="btn btn-primary" style="width:100%;justify-content:center;padding:11px;margin-bottom:16px">
            ...
            <div id="forgotView" style="display:none">
                ...
                <div class="forgot-step active" id="forgotStep1">
                    <div class="form-group">
                        ...
                        <input class="form-input" id="forgotEmail" placeholder="Enter your email" type="email">
                    </div>
    ...
    <div class="auth-right">
        ...
        <div class="auth-right-text">
            ...
            <!--CamboTech --><h2>Etec Watch Store</h2>
...
<div id="dashScreen" class="app" style="display:none">
    ...
    <div class="sidebar">
        <div class="brand">
            <div class="brand-name">⌚ Etec Watch</div>  <!--CamboTech -->
...
<!-- Load scripts ONCE at the bottom only -->
