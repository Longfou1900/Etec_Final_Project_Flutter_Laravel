...
<body>
    ...
    <div class="auth-left">
        ...
        <div id="loginView">
            ...
            <input class="form-input" id="loginUser"  type="email"
             placeholder="Enter email" value="admin@demo.com">
            </div>
            <div class="form-group">
            <label class="form-label">Password</label>
            <div class="input-wrap">
                <input class="form-input" id="loginPass" type="password" placeholder="Enter password" value="password">
